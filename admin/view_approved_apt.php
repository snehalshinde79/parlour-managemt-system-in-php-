...
if(isset($_POST['view_approve_btn']))
{
  $search_id=$_POST['view_approve_id'];
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-6">
                        <button style="float:right;margin-bottom: 10px;"class="btn btn-gradient-danger" onclick="location.href ='approved_apt.php' ";>Return</button>
                      </div>
                    </div>
