...
{
    $del_id=$_POST['del_service_id'];

    $query="DELETE FROM services WHERE id='$del_id'";
     ...
     <!-- Success Modal -->
        ...
        <div class="modal fade" id="modaldelfailure" tabindex="-1" role="dialog" aria-labelledby="successModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  ...
                  <div class="modal-footer">
                      <button type="button" class="btn btn-outline-danger" onclick="location.href = 'viewservice.php'";>data-dismiss="modal">Close</button>
                      <button type="button" class="btn btn-outline-primary" onclick="location.href = 'viewservice.php'";>Try Again</button>
                  </div>
                  </div>
              </div>
        </div>
